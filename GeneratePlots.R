...
ggsave(
  filename = paste0("Plots/", fname, ".png"),
  plot = ABMTs_res,
...
ggsave(
  filename = paste0("Plots/Exp1_boxplot.png"),
  plot = Exp1_boxplot,
  width = 10, height = 8, dpi = 300
)
...
ggsave(
  filename = paste0("Plots/Exp2_LinInt_normed_SSP245_adapted.png"),
  plot = Exp2_LinInt,
  width = 10, height = 8, dpi = 300
)
...
ggsave(
  filename = paste0("Plots/tradeoff_heatmaps_SSP245_50ADOP_colouradapt.png"),
...
ggsave(
  filename = paste0("Plots/Exp3_boxplot.png"),
  plot = Exp3_plot,
  width = 10, height = 8, dpi = 300
)
